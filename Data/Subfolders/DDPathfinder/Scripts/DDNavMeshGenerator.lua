...
local function CalculateNavGrid()
    ...
    for x = 1, NUM_TILES.X do
        for y = 1, NUM_TILES.Y do
            ...
            local findZLowestRayPos = GetGridTileWorldPos(x, y, 1) - halfGridSizeOffsetVec
            local findZHighestRayPos = GetGridTileWorldPos(x, y, NUM_TILES.Z) + halfGridSizeOffsetVec
            ...
            if findZHitResult then
                ...
                for z = 1, zEnd do
                    ...
                    local rayStartPos = pos + halfGridSizeOffsetVec
                    local rayEndPos = pos - halfGridSizeOffsetVec
